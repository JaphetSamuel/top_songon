...
import 'package:songontop/screens/account/theme.dart';
import 'package:songontop/screens/account/widgets/snackbar.dart';
...
class _SignInState extends State<SignIn> {
  ...
  void _toggleSignInButton() {
    CustomSnackBar(context, const Text('Enregistrer'));
    _profilController.email.value = loginEmailController.text;
  }
